...
<?php $__env->startSection('page_title', 'Nuevo Cliente'); ?>
...
<div class="card card-primary">
    ...
    <form method="POST" action="<?php echo e(route('customers.store')); ?>" id="customerForm">
        <?php echo csrf_field(); ?>
        ...
        <div class="card-footer">
            <a href="<?php echo e(route('customers.index', ['company_id' => $companyId])); ?>" class="btn btn-secondary">Cancelar</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\facturafacil\resources\views\customers\create.blade.php ENDPATH**/ ?>