<?php $__env->startSection('title', 'Restaurante'); ?>
<?php $__env->startSection('page_title', 'Restaurante'); ?>
    ...
    <div class="floors-section">
        <div class="floors-header">
            <div>
                ...
                <span class="badge badge-<?php echo e($printServerRunning ? 'success' : 'danger'); ?>" style="font-size:9px; margin-left:5px;">
                    <i class="fas fa-<?php echo e($printServerRunning ? 'check-circle' : 'times-circle'); ?>"></i>
                    Print Server <?php echo e($printServerRunning ? 'activo' : 'inactivo'); ?>

                </span>
                <?php endif; ?>
            </div>
            <span class="badge badge-<?php echo e($orderMode === 'print' ? 'info' : 'secondary'); ?>" style="font-size:11px;">
                <i class="fas <?php echo e($orderMode === 'print' ? 'fa-print' : 'fa-tv'); ?>"></i>
                <?php echo e($orderMode === 'print' ? 'Impresión 80mm' : 'KDS'); ?>
        ...
        <div class="floors-tabs" id="floorsTabs">
            ...
            <button class="floor-tab <?php echo e($loop->first ? 'active' : ''); ?>" data-floor-id="<?php echo e($floor->id); ?>" onclick="selectFloor(<?php echo e($floor->id); ?>)">
        ...
        <div class="tables-grid" id="tablesGrid">
            <?php $__currentLoopData = $floors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $floor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $floor->tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="table-card <?php echo e(strtolower($table->status)); ?> <?php echo e($table->activeOrder() ? 'has-order' : ''); ?>"
                     data-table-id="<?php echo e($table->id); ?>"
                     data-floor-id="<?php echo e($floor->id); ?>"
                     data-order-id="<?php echo e($table->activeOrder()?->id); ?>"
                     onclick="selectTable(<?php echo e($table->id); ?>)">
                    <i class="fas fa-chair"></i>
                    <div class="table-name"><?php echo e($table->name); ?></div>
                    <div class="table-capacity"><i class="fas fa-users"></i> <?php echo e($table->capacity); ?></div>
                    <?php if($table->activeOrder()): ?>
                    <div class="table-order"><?php echo e($table->activeOrder()->order_number); ?></div>
                    <?php endif; ?>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="modal-content-area">
        <div id="tabProducts">
            <div class="products-categories" id="productsCategories">
                ...
                <button class="category-btn" data-category="<?php echo e($category->id); ?>" onclick="filterProducts(<?php echo e($category->id); ?>)">
            ...
            <div class="products-grid" id="productsList">
                ...
                <div class="product-card"
                     ...
                     data-product-name="<?php echo e($product->descripcion); ?>"
                     data-product-price="<?php echo e($product->precio); ?>"
                     onclick="addProductToOrder(<?php echo e($product->id); ?>)">
                    <div class="product-name"><?php echo e($product->descripcion); ?></div>
                    <div class="product-price">S/ <?php echo e(number_format($product->precio, 2)); ?></div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
let productsData = <?php echo json_encode($products, 15, 512) ?>;
let customersData = <?php echo json_encode($customers, 15, 512) ?>;
let seriesData = <?php echo json_encode($series, 15, 512) ?>;
let allFloors = <?php echo json_encode($floors, 15, 512) ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\facturafacil\resources\views\restaurant\index.blade.php ENDPATH**/ ?>