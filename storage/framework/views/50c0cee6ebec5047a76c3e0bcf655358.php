...
<?php $__env->startSection('page_title', 'Editar Cliente'); ?>
...
<div class="card card-primary">
    ...
    <form method="POST" action="<?php echo e(route('customers.update', $customer)); ?>">
        ...
        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="documento_tipo" class="form-control" required>
                            <option value="1" <?php echo e($customer->documento_tipo == '1' ? 'selected' : ''); ?>>DNI</option>
                            <option value="6" <?php echo e($customer->documento_tipo == '6' ? 'selected' : ''); ?>>RUC</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="documento_numero" value="<?php echo e($customer->documento_numero); ?>" class="form-control" required>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label>Nombre / Razón Social</label>
                <input type="text" name="nombre" value="<?php echo e($customer->nombre); ?>" class="form-control" required>
            </div>
            <div class="form-group">
                <label>Dirección</label>
                <input type="text" name="direccion" value="<?php echo e($customer->direccion); ?>" class="form-control">
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <input type="hidden" name="ubigeo" id="ubigeo_codigo" value="<?php echo e($customer->ubigeo); ?>">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Teléfono</label>
                        <input type="text" name="telefono" value="<?php echo e($customer->telefono); ?>" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
        ...
        <div class="card-footer">
            <a href="<?php echo e(route('customers.show', $customer)); ?>" class="btn btn-secondary">Cancelar</a>
...
const currentUbigeo = "<?php echo e($customer->ubigeo); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\facturafacil\resources\views\customers\edit.blade.php ENDPATH**/ ?>