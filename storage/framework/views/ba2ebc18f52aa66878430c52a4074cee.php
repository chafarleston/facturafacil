...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'FacturaFacil by RealComputer SAC'); ?> - Admin</title>
...
<body class="hold-transition sidebar-mini sidebar-collapse">
  <div class="wrapper">
      ...
      <div class="sidebar">
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_dashboard')): ?>
            <li class="nav-item">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_companies')): ?>
            <li class="nav-item">
              <a href="#" class="nav-link <?php echo e(request()->routeIs('companies.*') || request()->routeIs('series.*') || request()->routeIs('users.*') || request()->routeIs('roles.*') || request()->routeIs('permissions.*') ? 'active' : ''); ?>">
                <i class="nav-icon fas fa-building"></i>
                <p>Empresas<i class="fas fa-angle-left right"></i></p>
              </a>
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo e(route('companies.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Datos de Empresa</p></a>
                </li>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_series')): ?>
                <li class="nav-item">
                  <a href="<?php echo e(route('series.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Series</p></a>
                </li>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_users')): ?>
                <li class="nav-item">
                  <a href="<?php echo e(route('users.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Usuarios</p></a>
                </li>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_roles')): ?>
                <li class="nav-item">
                  <a href="<?php echo e(route('roles.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Roles</p></a>
                </li>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_permissions')): ?>
                <li class="nav-item">
                  <a href="<?php echo e(route('permissions.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Permisos</p></a>
                </li>
                <?php endif; ?>
              </ul>
            </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_customers')): ?>
            <li class="nav-item">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_products')): ?>
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo e(route('products.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Lista de Productos</p></a>
                </li>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_categories')): ?>
                <li class="nav-item">
                  <a href="<?php echo e(route('categories.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Categorías</p></a>
                </li>
                <?php endif; ?>
              </ul>
            </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_invoices')): ?>
            <li class="nav-item">
              <a href="#" class="nav-link <?php echo e(request()->routeIs('invoices.*') ? 'active' : ''); ?>">
                <i class="nav-icon fas fa-file-invoice"></i>
                <p>Comprobantes<i class="fas fa-angle-left right"></i></p>
              </a>
              <ul class="nav nav-treeview">
                <li class="nav-item"><a href="<?php echo e(route('invoices.index', ['type' => '01'])); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Facturas</p></a></li>
                <li class="nav-item"><a href="<?php echo e(route('invoices.index', ['type' => '03'])); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Boletas</p></a></li>
                <li class="nav-item"><a href="<?php echo e(route('invoices.index', ['type' => 'NV'])); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Notas de Venta</p></a></li>
                <li class="nav-item"><a href="<?php echo e(route('invoices.create')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Nuevo Comprobante</p></a></li>
              </ul>
            </li>
            <?php endif; ?>
            
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_purchases')): ?>
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item"><a href="<?php echo e(route('purchases.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Lista de Compras</p></a></li>
                <li class="nav-item"><a href="<?php echo e(route('purchases.create')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Nueva Compra</p></a></li>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_suppliers')): ?>
                <li class="nav-item"><a href="<?php echo e(route('suppliers.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Proveedores</p></a></li>
                <?php endif; ?>
              </ul>
            </li>
            <?php endif; ?>
            
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_cashregisters')): ?>
            <li class="nav-item">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_pos')): ?>
            <li class="nav-item">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_restaurant')): ?>
            <li class="nav-item">
              <a href="#" class="nav-link <?php echo e(request()->routeIs('restaurant.*') ? 'active' : ''); ?>">
                <i class="nav-icon fas fa-utensils"></i>
                <p>Restaurante<i class="fas fa-angle-left right"></i></p>
              </a>
              <ul class="nav nav-treeview">
                <li class="nav-item"><a href="<?php echo e(route('restaurant.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Mesas</p></a></li>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_kitchen')): ?>
                <li class="nav-item"><a href="<?php echo e(route('restaurant.kitchen.cocina')); ?>" class="nav-link" target="_blank"><i class="far fa-circle nav-icon"></i><p>KDS Cocina</p></a></li>
                <li class="nav-item"><a href="<?php echo e(route('restaurant.kitchen.cocina2')); ?>" class="nav-link" target="_blank"><i class="far fa-circle nav-icon"></i><p>KDS Cocina 2</p></a></li>
                <li class="nav-item"><a href="<?php echo e(route('restaurant.kitchen.bar')); ?>" class="nav-link" target="_blank"><i class="far fa-circle nav-icon"></i><p>KDS Bar</p></a></li>
                <?php endif; ?>
                <li class="nav-item"><a href="<?php echo e(route('restaurant.floors.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Pisos</p></a></li>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_order_mode')): ?>
                <li class="nav-item"><a href="<?php echo e(route('restaurant.mode')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Modo de Pedidos</p></a></li>
                <?php endif; ?>
              </ul>
            </li>
            <?php endif; ?>

            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_printers')): ?>
            <li class="nav-item">
              <a href="#" class="nav-link <?php echo e(request()->routeIs('printers.*') ? 'active' : ''); ?>">
                <i class="nav-icon fas fa-print"></i>
                <p>Impresoras<i class="fas fa-angle-left right"></i></p>
              </a>
              <ul class="nav nav-treeview">
                <li class="nav-item"><a href="<?php echo e(route('printers.index')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Configuración</p></a></li>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission', 'view_print_queue')): ?>
                <li class="nav-item"><a href="<?php echo e(route('printers.queue')); ?>" class="nav-link"><i class="far fa-circle nav-icon"></i><p>Cola de Impresión</p></a></li>
                <?php endif; ?>
              </ul>
            </li>
            <?php endif; ?>
    ...
    <footer class="main-footer">
      ...
      <strong>FacturaFacil by RealComputer SAC &copy; <?php echo e(date('Y')); ?></strong>
    </footer>
  </div>
