...
<?php $__env->startSection('title', 'Nota de Crédito'); ?>
<?php $__env->startSection('page_title', 'Nota de Crédito'); ?>
...
<div class="row">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td><?php echo e($invoice->tipo_documento == '01' ? 'FACTURA' : 'BOLETA'); ?></td>
                    </tr>
                    <tr>
                        <td><strong>Número:</strong></td>
                        <td><?php echo e($invoice->full_number); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($invoice->customer->nombre); ?><br><small><?php echo e($invoice->customer->documento_tipo == '6' ? 'RUC: ' : 'DNI: '); ?><?php echo e($invoice->customer->documento_numero); ?></small></td>
                    </tr>
                </table>
            </div>
        </div>
    ...
    <div class="col-md-6">
        <div class="card card-primary">
            ...
            <form action="<?php echo e(route('invoices.sendCreditNote', $invoice)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <p class="h4 text-success">S/ <?php echo e(number_format($invoice->total, 2)); ?></p>
                ...
                <div class="card-footer">
                    ...
                    <a href="<?php echo e(route('invoices.show', $invoice)); ?>" class="btn btn-secondary">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\facturafacil\resources\views\invoices\credit-note.blade.php ENDPATH**/ ?>