...
<body>
    <div class="header">
        <div class="bold" style="font-size:14px;"><?php echo e($company->nombre_comercial ?? $company->razon_social); ?></div>
        <div>RUC: <?php echo e($company->ruc); ?></div>
        <div class="bold" style="font-size:16px; margin-top:10px;">RESUMEN DE CAJA</div>
        <div>Caja #<?php echo e($cashregister->id); ?></div>
    </div>

    <table>
        <tr>
            <td>Fecha:</td>
            <td class="text-right"><?php echo e($cashregister->fecha_apertura->format('d/m/Y H:i')); ?> - <?php echo e($cashregister->fecha_cierre ? $cashregister->fecha_cierre->format('d/m/Y H:i') : 'Ahora'); ?></td>
        </tr>
        <tr>
            <td>Usuario:</td>
            <td class="text-right"><?php echo e($cashregister->user->name); ?></td>
        </tr>
        <tr>
            <td>Monto Apertura:</td>
            <td class="text-right">S/ <?php echo e(number_format($cashregister->monto_apertura, 2)); ?></td>
        </tr>
        <tr>
            <td>Monto Cierre:</td>
            <td class="text-right">S/ <?php echo e(number_format($cashregister->monto_cierre ?? 0, 2)); ?></td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tr>
            <td>Facturas (01):</td>
            <td class="text-right"><?php echo e($facturas->count()); ?></td>
            <td class="text-right">S/ <?php echo e(number_format($facturas->sum('total'), 2)); ?></td>
        </tr>
        <tr>
            <td>Boletas (03):</td>
            <td class="text-right"><?php echo e($boletas->count()); ?></td>
            <td class="text-right">S/ <?php echo e(number_format($boletas->sum('total'), 2)); ?></td>
        </tr>
        <tr>
            <td>Notas de Venta (NV):</td>
            <td class="text-right"><?php echo e($nvs->count()); ?></td>
            <td class="text-right">S/ <?php echo e(number_format($nvs->sum('total'), 2)); ?></td>
        </tr>
        <tr class="bold border-top">
            <td>TOTAL:</td>
            <td class="text-right"><?php echo e($facturas->count() + $boletas->count() + $nvs->count()); ?></td>
            <td class="text-right">S/ <?php echo e(number_format($cashregister->total_ventas, 2)); ?></td>
        </tr>
    </table>
    ...
    <table>
        <tr>
            <td>Efectivo:</td>
            <td class="text-right">S/ <?php echo e(number_format($cashregister->ventas_efectivo, 2)); ?></td>
        </tr>
        <tr>
            <td>Tarjeta:</td>
            <td class="text-right">S/ <?php echo e(number_format($cashregister->ventas_tarjeta, 2)); ?></td>
        </tr>
        <tr>
            <td>Yape:</td>
            <td class="text-right">S/ <?php echo e(number_format($cashregister->ventas_yape, 2)); ?></td>
        </tr>
        <tr>
            <td>Plin:</td>
            <td class="text-right">S/ <?php echo e(number_format($cashregister->ventas_plin, 2)); ?></td>
        </tr>
        <tr>
            <td>Otro:</td>
            <td class="text-right">S/ <?php echo e(number_format($cashregister->ventas_otro, 2)); ?></td>
        </tr>
        <tr class="bold border-top">
            <td>TOTAL VENTAS:</td>
            <td class="text-right">S/ <?php echo e(number_format($cashregister->total_ventas, 2)); ?></td>
    ...
    <div style="margin-bottom:4px; font-size:10px;">Hay <?php echo e(count($lineasEliminadas)); ?> línea(s) eliminada(s) en el Sistema</div>
    <table>
        <tr class="bold border-bottom">
            <td>Producto</td>
    ...
    <div class="text-center mt-4" style="font-size:9px;">
        Documento generado el <?php echo e(now()->format('d/m/Y H:i')); ?>

    </div>
</body>
</html><?php /**PATH C:\laragon\www\facturafacil\resources\views\cashregisters\pdf.blade.php ENDPATH**/ ?>