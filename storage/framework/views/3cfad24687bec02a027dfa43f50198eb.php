...
<?php $__env->startSection('page_title', 'Nueva Compra'); ?>
...
<div class="card card-primary">
    ...
    <form method="POST" action="<?php echo e(route('purchases.store')); ?>">
            ...
            <div class="form-group">
                ...
                <select name="supplier_id" class="form-control">
                    ...
                    <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($s->id); ?>"><?php echo e($s->nombre); ?> - <?php echo e($s->ruc); ?></option>
                    ...
                    <div class="form-group mb-0">
                        ...
                        <select id="productSelect" class="form-control">
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($p->id); ?>" data-price="<?php echo e($p->precio); ?>" data-stock="<?php echo e($p->stock); ?>"><?php echo e($p->codigo); ?> - <?php echo e($p->descripcion); ?> (Stock: <?php echo e($p->stock); ?>)</option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
        ...
        <div class="card-footer">
            <a href="<?php echo e(route('purchases.index', ['company_id' => $companyId])); ?>" class="btn btn-secondary">Cancelar</a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\facturafacil\resources\views\purchases\create.blade.php ENDPATH**/ ?>